...
.PHONY: gen
gen: image-to-ascii.py images/*.jpg   ## Convert all images to ASCII arts
	for img in images/*.jpg; do art="$${img/images/ascii-arts}" && ./image-to-ascii.py $$img >"$${art/jpg/txt}"; done
